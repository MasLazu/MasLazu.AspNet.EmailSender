...
namespace MasLazu.AspNet.EmailSender.SendGrid.Renderers;

/// <summary>
/// A Razor HTML renderer for SendGrid emails that creates beautiful email layouts using Razor templates.
/// </summary>
public class SendGridHtmlRenderer : IHtmlRenderer
{
